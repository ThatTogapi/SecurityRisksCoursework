...
def man_in_the_middle_attack(encrypted_message, derived_key_attacker1, derived_key_attacker2):
    ...
    modified_message = b"Modified message from the attacker"

    reencrypted_message = encrypt_message(derived_key_attacker2, modified_message)

    return reencrypted_message, decrypted_message
...
reencrypted_message, received_message = man_in_the_middle_attack(encrypted_message, derived_key_user1, derived_key_attacker2)
iv, ciphertext = reencrypted_message

decrypted_message = decrypt_message(derived_key_attacker2, iv, ciphertext)

print("Original Message from Alice to Bob:", message)
print("Received messsage from Alice to the attacker:" , received_message)
print("Modified Message received by Bob:", decrypted_message)
